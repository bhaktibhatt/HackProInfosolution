    ...
    <div className='relative w-full font-raleway'>
      ...
      <div className='w-full absolute top-1/4'>
        <div className='flex flex-col items-center'>
          ...
          <div className='flex items-center w-[256px] justify-between py-[8px] lg:space-x-[16px]'>
          ...
          <h6 className='text-[14px] lg:text-[20px]'>Made By <a className='text-blue-500' href='https://github.com/bhaktibhatt'>bhaktibhatt</a> and <a className='text-blue-500' href='https://github.com/prathmesh-ka-github'>Pratham-c0des</a></h6>
        </div>
      </div>
