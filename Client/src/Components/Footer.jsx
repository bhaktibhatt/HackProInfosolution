...
const Footer = () => {
  return (
    ...
    <div className=' w-full font-raleway text-white'>
      <div className='relative flex flex-row w-full p-[100px] justify-around items-start border-b-2 border-green bg-black2'>
      {/* <img className='absolute w-full opacity-40 -z-10 h-[500px]' src={footerBg} alt="" /> */}
        ...
        <div className='flex flex-col'>
          <h2 className='font-semibold text-[20px]'>Browser</h2>
          <ul>
        ...
        <div className='flex flex-col'>
          ...
          <ul>
            <li className=" flex font-mono gap-[10px]">
      ...
      <div className='flex py-[10px] bg-black2 justify-between p-[30px]'>
          <p className='font-semibold'>© Copyright 2024 HackPro Infosolution</p>
          <p className='font-semibold'>Designed and Developed By <span className='hover:text-green font-mono'><a href='https://github.com/bhaktibhatt'>bhaktibhatt</a></span> and <span className='hover:text-green font-mono'><a href='https://github.com/prathmesh-ka-github'>prathamc0des</a></span></p>
      </div>
    </div>
  )
}
