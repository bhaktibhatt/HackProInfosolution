...
const card = (props) => {
  return (
    <div className='relative lg:h-[350px] lg:w-[400px] w-[290px] h-[280px] p-[20px] lg:p-[24px] flex flex-col items-center gap-[15px] lg:gap-[15px] border border-green rounded-[24px] hover:shadow-2xl scale-90  hover:scale-100 transition-all'>
