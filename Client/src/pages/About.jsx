  ...
  return (
    <div>
      <div className='relative'>
        ...
        <h1 className='absolute  text-5xl lg:text-8xl underline font-semibold top-12 left-10 lg:top-72 lg:left-20'>About Us</h1>
        <div className='mx-10 lg:mx-44 w-100 text-center lg:text-3xl space-y-10 lg:space-y-28'>
